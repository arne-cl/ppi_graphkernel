...
def splitPathStyles(styleString):
    ...
    for split in splits:
        ...
        assert(styleSplits[0] == "binary" or styleSplits[0] == "all_tertiary" or styleSplits[0] == "closest_tertiary" or styleSplits[0] == "root")
        assert(styleSplits[1] == "all_shortest" or styleSplits[1] == "random_shortest" or styleSplits[1] == "all")
        assert(styleSplits[2] == "directed" or styleSplits[2] == "nondirected")
        style = {"type":None,"length":None,"direction":None,"weight":None}
...
# Based on example in DependencyAnalyser.py
class DijkstraNode:
    def __init__(self):
        self.incoming = []
        self.outgoing = []
